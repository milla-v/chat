...
GOOS=freebsd GOARCH=amd64 go build -ldflags "-X github.com/milla-v/chat/service.version=$VERSION -X github.com/milla-v/chat/service.date=$DATE" -o chatd-freebsd github.com/milla-v/chat/cmd/chatd
